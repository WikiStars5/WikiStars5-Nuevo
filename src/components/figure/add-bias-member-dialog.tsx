...
interface AddBiasMemberDialogProps {
  onAdd: (figure: Figure) => void;
  existingIds: string[];
  onClose: () => void;
}

export default function AddBiasMemberDialog({ onAdd, existingIds, onClose }: AddBiasMemberDialogProps) {
  ...
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Añadir Miembro a Bias BTS</DialogTitle>
        <DialogDescription>
