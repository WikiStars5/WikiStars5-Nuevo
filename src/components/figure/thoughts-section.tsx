...
import { ThoughtDisplay } from './thought-display';
import type { Thought, GlobalSettings } from '@/lib/types';
        ...
        <Card className={cn("overflow-hidden border-border/40", (theme === 'dark' || theme === 'army') && 'bg-black')}>
            <CardContent className="p-4 space-y-4">
                ...
                {Number(thought.replyCount) > 0 && (
                    <button 
                        className="text-xs p-0 h-auto text-primary font-bold hover:underline" 
                        onClick={() => {
